...
(function () {
  ...
  function start(root, api) {
    ...
    api.deck({
      ...
      padBig: true,
      actions: [
        // Значок — сомкнутое кольцо со стрелкой по часовой, туда же, куда
        // уходит барабан. С «заново» его больше не спутать: та кнопка
        // уехала наверх и подписана словом.
        { icon: "spin", aria: "крутить", color: "#ff3fa4", big: true, down: spin },
      ],
      extra: [
        { icon: "replay", label: "ЗАНОВО", aria: "сбросить серию",
